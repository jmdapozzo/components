...
IOExpander::IOExpander()
{
    ...
    ESP_ERROR_CHECK(i2c_master_get_bus_handle(CONFIG_IO_EXPANDER_I2C_PORT_NUM, &i2c_master_bus_handle));

    // Probe for the I/O Expander device
    if (i2c_master_probe(i2c_master_bus_handle, CONFIG_IO_EXPANDER_I2C_ADDR, 100) != ESP_OK)
    {
        ESP_LOGW(TAG, "PCF8574 not found at address 0x%02X", CONFIG_IO_EXPANDER_I2C_ADDR);
        return;
    }

    ESP_LOGI(TAG, "Found PCF8574 at address 0x%02X", CONFIG_IO_EXPANDER_I2C_ADDR);
    m_is_present = true;
    ...
    i2c_device_config_t i2c_device_config = {
        ...
        .device_address = CONFIG_IO_EXPANDER_I2C_ADDR,
