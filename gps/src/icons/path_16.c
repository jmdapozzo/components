...
#ifndef LV_ATTRIBUTE_IMAGE_PATH_16
#define LV_ATTRIBUTE_IMAGE_PATH_16
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_PATH_16 uint8_t path_16_map[] = {
