...
#ifndef LV_ATTRIBUTE_IMAGE_GPS_16
#define LV_ATTRIBUTE_IMAGE_GPS_16
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMAGE_GPS_16 uint8_t gps_16_map[] = {
